...
> Generated from [`threats.json`](threats.json) by `matrix`. Do not edit this file directly.
...
Regenerate with `matrix render -config config.json -doc threats.json -output threats.md`; verify with `matrix render -config config.json -doc threats.json -output threats.md -check`.
